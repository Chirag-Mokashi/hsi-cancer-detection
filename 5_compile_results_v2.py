# coding: utf-8
# 5_compile_results_v2.py
# V2 results compilation — run after HybridSN v2 + ViT v2 complete on Colab.
# Output goes to results/summary_v2/ (never overwrites v1 outputs).
...
SUMMARY_DIR = RESULTS_DIR / 'summary_v2'
SUMMARY_DIR.mkdir(parents=True, exist_ok=True)

# Model result files (update version suffix if re-run with v2 etc.)
MODEL_CSVS = {  # v2 paths — run after HybridSN v2 + ViT v2 complete
    'RF':       RESULTS_DIR / 'RF_v2'    / 'rf_v2_results.csv',
    'SVM':      RESULTS_DIR / 'SVM_v2'   / 'svm_v2_results.csv',
    'HybridSN': RESULTS_DIR / 'HybridSN' / 'hybridSN_v2_results.csv',
    'ViT':      RESULTS_DIR / 'ViT'      / 'vit_v2_results.csv',
}
